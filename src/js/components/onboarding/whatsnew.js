...
class WhatsNew extends Component {
  ...
  // onGotItClick (app_updateNo, handleGotIt) {
  //   // console.log('onGotItClick this.props', this.props);
  ...
  render () {
    ...
    const { type, additionalInfo, eventCode, user_updateNo, app_updateNo, handleGotIt } = this.props;
    ...
    return (
      <Modal
        ...
        onRequestClose={() => handleGotIt(app_updateNo)}
      >
...

          {
            ...
            <ModalView>
              ...
              <ConfirmButton
                ...
                onPress={() => handleGotIt(app_updateNo)}
